...
Перед внесением любых изменений ознакомьтесь с [руководством по стилю](/docs/styleguide.md) и [практиками проекта](/docs/practices.md). Также для ознакомления со структурой проекта можете прочитать [`architecture.md`](/docs/architecture.md).
